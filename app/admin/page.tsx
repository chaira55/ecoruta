...
export default function AdminPage() {
  ...
  const kpiCards = kpis ? [
    { label: "Total reportes", valor: kpis.total, emoji: "📍", color: "bg-blue-50 text-blue-700" },
    { label: "Emergencias", valor: kpis.emergencias, emoji: "🚨", color: "bg-red-50 text-red-700" },
    { label: "Solicitudes", valor: kpis.solicitudes, emoji: "♻️", color: "bg-green-50 text-green-700" },
    { label: "Completados", valor: kpis.completados, emoji: "✅", color: "bg-emerald-50 text-emerald-700" },
    { label: "kg desviados", valor: `${kpis.kgDesviados.toFixed(1)} kg`, emoji: "⚖️", color: "bg-yellow-50 text-yellow-700" },
    { label: "CO₂ evitado", valor: `${kpis.co2Evitado.toFixed(2)} kg`, emoji: "🌿", color: "bg-teal-50 text-teal-700" },
  ] : [];
